            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="header">
                        ...
                        <h4 class="box-title">  <span class="badge badge-primary position-right">Total Tasks : {{ $pasengercnt }}</span></h4>
                    </div>
                    <div class="body">
                        @if ($errors->any())
                                    ...
                                    <td>{{ date('M j, Y h:ia', strtotime($order_detail->created_at)) }}</td>
                                        <td>
                                         <a onclick="fetchPost({{ $order_detail->id }})">
                                             <button type="button" class="btn btn-primary pd-x-20" data-toggle="modal" data-target="#editfaqsModal2">Edit <i class="fa fa-edit"></i></button>
                                           </a>
